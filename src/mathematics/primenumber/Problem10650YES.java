...
public class Problem10650YES {
    ...
    /**
     * Note: 1. If all numbers are in the sequence not included in interval, then don't print them. 2. Last number in
     * one sequence could be used in the next sequence.
     */
